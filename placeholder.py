...
filename = "/home/rey/Imágenes/original_shack.jpg"    #imagen a extraer los datos altura: 400 y anchura: 400
...
#función slice: image= imagen de entrada, begin=tiene que ser menor que la altura por ejemplo la altura máxima es 400 
#entonces begin solo puede iniciar con un valor menor a 400 tambien dependiendo del tamaño a cortar, ya que el corte no 
